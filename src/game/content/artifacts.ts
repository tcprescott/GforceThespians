...
// ===========================================================================
// Artifacts — one-time, expensive, PERSISTENT Legacy purchases. Each is a
...
export const ARTIFACTS: ArtifactDef[] = [
  {
    id: 'a-the-first-box',
    name: 'The First Playbill',
    description: 'The very playbill from opening night, framed in gold. All production ×3, permanently.',
    cost: 5,
  ...
  },
  {
    ...
    description: 'A spotlight that never dims. Bravos ×5 and Cue ×10.',
    cost: 15,
    effects: [
  ...
  },
  {
    ...
    name: 'The Bottomless Urn',
    description: 'A coffee urn that refills from nothing. Coffee ×8 and all generator costs ×0.8.',
    cost: 30,
    effects: [
  ...
  },
  {
    ...
    description: 'Strike it and the cosmos resolves to a perfect chord. Comedy ×6, Tragedy ×6.',
    cost: 60,
    effects: [
  ...
  {
    id: 'a-pocket-moon',
    name: 'Bottled Limelight',
    description: 'You bottled a single shaft of it. Limelight ×12 and all production ×2.',
    cost: 120,
    effects: [
  ...
  },
  {
    id: 'a-the-ninth-life',
    name: 'The Final Bow',
    description: 'The last bow, saved for one more encore. Legacy ×4 and offline efficiency ×3.',
    cost: 200,
    effects: [
  ...
  // === EXPANSION artifacts ===============================================
  {
    ...
    description: 'Rub it on anything and it performs. Buzz ×8 and Cue ×20.',
    cost: 90,
    effects: [
  ...
  },
  {
    ...
    name: 'The Eternal Green Room',
    description: 'Catered across all of spacetime. Coffee ×15 and all costs ×0.7.',
    cost: 150,
    effects: [
  ...
  },
  {
    id: 'a-the-encore-key',
    name: 'The Encore Key',
    description: 'Unlocks the door marked "again". Legacy ×8 and ALL production ×3.',
    cost: 800,
    effects: [
